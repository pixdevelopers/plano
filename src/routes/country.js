...
router.post('/', async (req, res, next) => {
    ...
    let country = new Country({ name:req.body.name , user=req.body._id });
...
router.put('/:id', async (req, res, next) => {
    ...
    const result = await Country.findByIdAndUpdate(req.params.id, { name: req.body.name, updatedAt, user=req.body._id }, { new: true });
