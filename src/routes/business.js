...
router.post('/', async (req, res, next) => {
    ...
    let business = new Business({ name: req.body.params.name, client:req.body._id });
...
router.put('/:id', async (req, res, next) => {
    ...
    const result = await Business.findByIdAndUpdate(req.params.id, { name: req.body.params.name, updatedAt: updatedAt, client: req.body._id }, { new: true });
