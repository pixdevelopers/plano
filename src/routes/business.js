...
router.post('/', async (req, res, next) => {
    ...
    let business = new Business({ name: req.body.name, userId=req.body._id });
...
router.put('/:id', async (req, res, next) => {
    ...
    const result = await Business.findByIdAndUpdate(req.params.id, { name: req.body.name, updatedAt, userId=req.body._id }, { new: true });
