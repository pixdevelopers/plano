...
router.put('/:id', async (req, res, next) => {
    ...
    const result = await City.findByIdAndUpdate(req.params.id, { name: req.body.params.name, updatedAt, country: req.body.params.countryId,  client:req.body._id }, { new: true });
